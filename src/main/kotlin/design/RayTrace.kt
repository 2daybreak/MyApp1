...
class RayTrace {
    ...
    private val inverseProjMat4 = Matrix4f()
    private val inverseViewMat4 = Matrix4f()

    fun set(point: Vector3f, projMat4: Matrix4f, viewMat4: Matrix4f) {
        // Assignment of Reference
        origin.set(point)
        inverseProjMat4.set(projMat4).invert()
        inverseViewMat4.set(viewMat4).invert()
    }
